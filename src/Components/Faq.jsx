...
const Faq = () => {
    return (
        ...
        <Container maxWidth={false} sx={{ backgroundColor : "black", marginBottom: 10}}>
        <Typography className='faq-header'  textAlign={"center"} backgroundColor={"black"} color={"white"} padding={"50px"} variant='h3'>
        ...
        <div className='faq'>
            <Accordion sx={{backgroundColor: "black", color: "white"}} >
                ...
                <AccordionDetails>
                    <Typography variant='h6'>
                        ...
                        Unlike traditional currencies, cryptocurrencies are not backed by a physical commodity or government,
                        and their value is determined by market demand and supply. Cryptocurrencies can be used to buy goods and
                        services, transfer funds, and trade in markets. Popular cryptocurrencies include Bitcoin, Ethereum, Litecoin, Ripple, and Cronos.
                    </Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion sx={{backgroundColor: "black", color: "white"}}>
            ...
            <Accordion sx={{backgroundColor: "black", color: "white"}}>
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography variant='h4'> What is the future of crypto trading in India?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography variant='h6' >
            ...
            <Accordion sx={{backgroundColor: "black", color: "white"}}>
                <AccordionSummary
                    ...
                    id="panel2a-header"
                >
                    <Typography variant='h4'>How to earn rewards on crypto?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography variant='h6'>
